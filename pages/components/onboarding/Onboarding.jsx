      ...
      <div className='container mt-[60px]'>
        <div className='max-h-[243px] flex items-center rounded-3xl' style={{"background":"linear-gradient(90deg, rgba(0, 0, 0, 0.83) 0%, rgba(0, 0, 0, 0.00) 100%), url('/img/base.png') no-repeat center","backgroundSize":"cover"}}>
          <div className='flex flex-col gap-y-3 xsm:px-[30px] md:pr-0 md:pl-[60px] xsm:py-[30px] md:py-[60px]'>
            <h3 className='xsm:text-[30px] sm:text-[35px] md:text-[40px] lg:text-[49px] headline-3 text-white !text-left opacity-90'>Onboarding</h3>
        ...
        <div className='mt-[120px]'>
          <h3 className='xsm:text-[30px] sm:text-[35px] md:text-[40px] lg:text-[49px] headline-3 !text-left !text-lms-pine-tree mb-[60px] opacity-90'>Basic Orientation Trainings</h3>
        ...
        <div className='mt-[120px]'>
          <h3 className='xsm:text-[30px] sm:text-[35px] md:text-[40px] lg:text-[49px] headline-3 !text-left !text-lms-pine-tree mb-[60px] opacity-90'>Technical Onboarding Trainings</h3>
          <div className='grid justify-center items-center xsm:grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-8'>
            <div className='bg-white category-card max-w-full h-[166px] rounded-3xl flex justify-center items-center'>
        ...
        <div className='mt-[120px]'>
          <h3 className='xsm:text-[30px] sm:text-[35px] md:text-[40px] lg:text-[49px] headline-3 !text-left !text-lms-pine-tree mb-[60px] opacity-90'>Onboarding Programs</h3>
          <div className='grid justify-center items-center xsm:grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-8'>
            <div className='bg-white category-card max-w-full h-[166px] rounded-3xl flex justify-center items-center'>
        ...
        <div className='my-[120px]'>
          <h3 className='xsm:text-[30px] sm:text-[35px] md:text-[40px] lg:text-[49px] headline-3 !text-left !text-lms-pine-tree mb-[60px] opacity-90'>Human Resources Trainings</h3>
          <div className='grid justify-center items-center xsm:grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-8'>
            <div className='bg-white category-card max-w-full h-[166px] rounded-3xl flex justify-center items-center'>
