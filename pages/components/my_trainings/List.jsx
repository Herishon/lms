    ...
    return (
        <>
            ...
            <div className='container'>
                <div className='max-w-[1094px] flex justify-between items-center xsm:flex-col sm:flex-row mx-auto mt-[60px]'>
                    <h1 className='xsm:text-[30px] sm:text-[35px] md:text-[40px] lg:text-[49px] headline-3 text-lms-pine-tree xsm:mb-4 sm:mb-0'>My Trainings</h1>
                ...
                <div className='mt-[60px] mb-[120px]'>
                    <div className='flex flex-col justify-center items-center gap-8'>
                        ...
                        <Link href="/components/learndash/LearnDash">
                            <div className='xsm:w-full xl:w-[1094px] max-h-fit bg-white flex xsm:flex-col sm:flex-row rounded-3xl box_shadow_4'>
                                <div className='min-w-[306px] relative'>
                                    <Image className='w-full xsm:h-fit sm:h-[172px] object-cover rounded-3xl' src={ image1 } width={ 306 } height={ 172 } alt="logo" />
                                ...
                                <div className='px-8 pb-8 pt-6'>
                                    <h3 className='headline-6 text-lms-pine-tree line-clamp-2'>
                                        Explore Management Concepts through Metaphor and Music
                                    </h3>
                                    <div className='max-w-full flex justify-center items-center mt-6 gap-8'>
                                        <p className="subtitle-2 text-lms-atlantis">0%</p>
                                        <div className="xsm:w-full xl:w-[671px] h-[24px] border border-lms-atlantis rounded-xl flex items-center">
                                            <div></div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <Link href="learndash/">
                            <div className='xsm:w-full xl:w-[1094px] max-h-fit bg-white flex xsm:flex-col sm:flex-row rounded-3xl box_shadow_4'>
                                <div className='min-w-[306px] relative'>
                                    <Image className='w-full xsm:h-fit sm:h-[172px] object-cover rounded-3xl' src={ image2 } width={ 306 } height={ 172 } alt="logo" />
                                    <div className='absolute top-0 right-0 bottom-0 left-0 rounded-3xl bg_overlay_shadow'></div>
                        ...
                        {/* Card */}
                        <Link href="learndash/">
                            <div className='xsm:max-w-full xl:w-[1094px] max-h-fit bg-white flex xsm:flex-col sm:flex-row rounded-3xl box_shadow_4'>
                                <div className='min-w-[306px] relative'>
                                    <Image className='w-full xsm:h-fit sm:h-[172px] object-cover rounded-3xl' src={ image1 } width={ 306 } height={ 172 } alt="logo" />
                                    <div className='absolute top-0 right-0 bottom-0 left-0 rounded-3xl bg_overlay_shadow'></div>
